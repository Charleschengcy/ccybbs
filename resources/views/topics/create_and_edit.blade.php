      ...
      <div class="card ">
        ...
        <div class="card-body">
          ...
          @endif
              ...
              <div class="form-group">
                <textarea name="body" class="form-control" id="editor" rows="6" placeholder="content required at least three characters." required>{{ old('body', $topic->body ) }}</textarea>
              </div>
    ...
    $(document).ready(function() {
      var editor = new Simditor({
        ...
        upload: {
          ...
          fileKey: 'upload_file',
          connectionCount: 3,
          leaveConfirm: 'File is uploading, are you sure to cancel it?'
        },
        pasteImage: true,
      });
    });
